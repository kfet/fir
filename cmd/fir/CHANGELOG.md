...
### Added
- Anthropic server-side tools support: `web_search_20250305` and `code_execution_20250522` can be passed via `StreamOptions.ServerTools` for Anthropic API calls
