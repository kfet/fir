...
_(none — build passing, all tests pass)_
...
- ~~`pkg/core/tools/read.go:110` — `filepath.Ext` regression for dotfiles~~ — ✅ FIXED 2026-02-19 (test updated to reflect new `filepath.Ext` semantics for `.hidden`)
