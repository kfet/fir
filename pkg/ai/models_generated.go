...
// Generated at: 2026-09-22T20:37:30Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.887226, Output: 1.774452, CacheRead: 0.0739355, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.1, Output: 0.8, CacheRead: 0.1, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     943718,
		Headers:       nil,
	})
