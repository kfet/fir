...
// Generated at: 2026-08-14T20:49:17Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.5605, Output: 2.36, CacheRead: 0.0944, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     262144,
		Headers:       nil,
		SWEScore:      70.9,
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.0798, Output: 0.1596, CacheRead: 0.01596, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     131072,
		Headers:       nil,
	})
