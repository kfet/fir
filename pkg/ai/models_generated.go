...
// Generated at: 2026-09-26T00:48:02Z
package ai
...
func init() {
	RegisterModel(&Model{
		...
		Cost:          ModelCost{Input: 0.33, Output: 2.75, CacheRead: 0.0825, CacheWrite: 0.33},
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.06, Output: 0.24, CacheRead: 0.015, CacheWrite: 0.06},
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.035, Output: 0.14, CacheRead: 0.00875, CacheWrite: 0.035},
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.8, Output: 3.2, CacheRead: 0.2, CacheWrite: 0.8},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.063, Output: 0.252, CacheRead: 0.01575, CacheWrite: 0.063},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.037, Output: 0.148, CacheRead: 0.00925, CacheWrite: 0.037},
		ContextWindow: 128000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.84, Output: 3.36, CacheRead: 0.21, CacheWrite: 0.84},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 4.4, Output: 22, CacheRead: 0.22, CacheWrite: 5.5},
		ContextWindow: 1000000,
		MaxTokens:     128000,
		Headers:       nil,
		SWEScore:      96,
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.064, Output: 0.256, CacheRead: 0.016, CacheWrite: 0.064},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.374, Output: 3.157, CacheRead: 0.0935, CacheWrite: 0.374},
		ContextWindow: 1000000,
		MaxTokens:     65535,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.069, Output: 0.276, CacheRead: 0.01725, CacheWrite: 0.069},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.04, Output: 0.16, CacheRead: 0.01, CacheWrite: 0.04},
		ContextWindow: 128000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.92, Output: 3.68, CacheRead: 0.23, CacheWrite: 0.92},
		ContextWindow: 300000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.3, Output: 2.5, CacheRead: 0.075, CacheWrite: 0.3},
		ContextWindow: 1000000,
		MaxTokens:     65535,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.396, Output: 3.311, CacheRead: 0.099, CacheWrite: 0.396},
		ContextWindow: 1000000,
		MaxTokens:     65535,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.53, Output: 2.66, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     262000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.084, Output: 0.36, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 128000,
		MaxTokens:     16384,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 2.5, Output: 12.5, CacheRead: 0.625, CacheWrite: 2.5},
		ContextWindow: 1000000,
		MaxTokens:     10000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.05, Output: 0.1, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 131072,
		MaxTokens:     131072,
		Headers:       nil,
		Compat:        &OpenAICompletionsCompat{SupportsDeveloperRole: boolRef(false)},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.834, Output: 2.501, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1000000,
		MaxTokens:     64000,
		Headers:       nil,
		Compat:        &OpenAICompletionsCompat{SupportsDeveloperRole: boolRef(false)},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.15, Output: 0.6, CacheRead: 0.003, CacheWrite: 0},
		ContextWindow: 1000000,
		MaxTokens:     384000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.3, Output: 1.5, CacheRead: 0.15, CacheWrite: 0},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.04704, Output: 0.09408, CacheRead: 0.009408, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.022, Output: 0.32, CacheRead: 0.016, CacheWrite: 0},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.429084, Output: 0.858168, CacheRead: 0.035757, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.264, Output: 0.792, CacheRead: 0.0088, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.14, Output: 0.42, CacheRead: 0.0042, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     131072,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.112, Output: 0.336, CacheRead: 0.00336, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     131072,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.06, Output: 0.25, CacheRead: 0.015, CacheWrite: 0},
		ContextWindow: 131072,
		MaxTokens:     117964,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.1875, Output: 0.6525, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     16384,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.15, Output: 0.45, CacheRead: 0.015, CacheWrite: 0},
		ContextWindow: 256000,
		MaxTokens:     204800,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.075, Output: 0.075, CacheRead: 0.0075, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     209715,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.2, Output: 1, CacheRead: 0.02, CacheWrite: 0},
		ContextWindow: 131072,
		MaxTokens:     104857,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.075, Output: 0.3, CacheRead: 0.0075, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     209715,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 2.28, Output: 11.4, CacheRead: 0.228, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     16384,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.05, Output: 0.25, CacheRead: 0.005, CacheWrite: 0.0625},
		ContextWindow: 1050000,
		MaxTokens:     128000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.024, Output: 0.112, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 131072,
		MaxTokens:     117964,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.35, Output: 1.4, CacheRead: 0.07, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     235929,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.15, Output: 0.47, CacheRead: 0.016, CacheWrite: 0},
		ContextWindow: 1000000,
		MaxTokens:     131072,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.09, Output: 0.36, CacheRead: 0.018, CacheWrite: 0},
		ContextWindow: 524288,
		MaxTokens:     131072,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 4.35, Output: 8.7, CacheRead: 0.036, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     131072,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.045, Output: 0.14, CacheRead: 0.01, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     128000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.06, Output: 0.2, CacheRead: 0.012, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     131072,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.035, Output: 0.29, CacheRead: 0.001, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.25, Output: 3.5, CacheRead: 0.249, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     943718,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 1.0301, Output: 9.043, CacheRead: 0.3, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     943718,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.5593, Output: 1.7578, CacheRead: 0.091885, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     943718,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 1.6162, Output: 4, CacheRead: 0.1364, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     8192,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.303, Output: 1.2121, CacheRead: 0.0061, CacheWrite: 0},
		ContextWindow: 393216,
		MaxTokens:     393216,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		ID:            "ds-v4.1-flash-el",
		Name:          "DS-V4.1-Flash-EL",
		API:           "openai-completions",
		Provider:      "poe",
		BaseURL:       "https://api.poe.com/v1",
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.303, Output: 1.2121, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1000000,
		MaxTokens:     8192,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.8424, Output: 2.5263, CacheRead: 0.0424, CacheWrite: 0},
		ContextWindow: 64000,
		MaxTokens:     64000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		ID:            "mimo-v2.6-flash-el",
		Name:          "MiMo-V2.6-Flash-EL",
		API:           "openai-completions",
		Provider:      "poe",
		BaseURL:       "https://api.poe.com/v1",
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.1414, Output: 0.2828, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     8192,
		Headers:       nil,
	})
	RegisterModel(&Model{
		ID:            "mimo-v2.6-pro-el",
		Name:          "MiMo-V2.6-Pro-EL",
		API:           "openai-completions",
		Provider:      "poe",
		BaseURL:       "https://api.poe.com/v1",
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.4394, Output: 0.8788, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     8192,
		Headers:       nil,
	})
	RegisterModel(&Model{
		ID:            "mimo-v2.6-pro-ultraspeed-el",
		Name:          "MiMo-V2.6-Pro-UltraSpeed-EL",
		API:           "openai-completions",
		Provider:      "poe",
		BaseURL:       "https://api.poe.com/v1",
		Reasoning:     false,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 4.3939, Output: 8.7879, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     8192,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.303, Output: 1.2121, CacheRead: 0.1515, CacheWrite: 0},
		ContextWindow: 204800,
		MaxTokens:     8192,
		Headers:       nil,
		SWEScore:      75.9,
	...
	RegisterModel(&Model{
		ID:            "qwen3.8-max-0902-el",
		Name:          "Qwen3.8-Max-0902-EL",
		API:           "openai-completions",
		Provider:      "poe",
		BaseURL:       "https://api.poe.com/v1",
		Reasoning:     false,
	...
	RegisterModel(&Model{
		ID:                    "step-5-preview-el",
		Name:                  "Step-5-Preview-EL",
		API:                   "openai-completions",
		Provider:              "poe",
		BaseURL:               "https://api.poe.com/v1",
		Reasoning:             false,
		Input:                 []string{"text", "image"},
		Cost:                  ModelCost{Input: 1.0101, Output: 2.7273, CacheRead: 0.0505, CacheWrite: 0},
		ContextWindow:         1024000,
		MaxTokens:             8192,
		Headers:               nil,
		ReasoningEffortValues: []string{"low", "medium", "high"},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 1.3, Output: 7.8, CacheRead: 0.13, CacheWrite: 1.625},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.1, Output: 0.4, CacheRead: 0.01, CacheWrite: 0.125},
		ContextWindow: 1000000,
		MaxTokens:     64000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:             true,
		Input:                 []string{"text", "image"},
		Cost:                  ModelCost{Input: 8, Output: 40, CacheRead: 0.4, CacheWrite: 10},
		ContextWindow:         1000000,
		MaxTokens:             128000,
		Headers:               nil,
		ServerTools:           []string{"web_search_20250305", "web_search_20260209", "web_fetch_20250910", "web_fetch_20260209", "code_execution_20250825"},
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.5, Output: 2.5, CacheRead: 0.1, CacheWrite: 0},
		ContextWindow: 262144,
		MaxTokens:     262144,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.04, Output: 0.17, CacheRead: 0, CacheWrite: 0},
		ContextWindow: 60288,
		MaxTokens:     16000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     false,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.3, Output: 0.72, CacheRead: 0.036, CacheWrite: 0},
		ContextWindow: 131000,
		MaxTokens:     4000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 8, Output: 40, CacheRead: 0.8, CacheWrite: 10},
		ContextWindow: 1050000,
		MaxTokens:     128000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.2, Output: 1, CacheRead: 0.02, CacheWrite: 0.25},
		ContextWindow: 1050000,
		MaxTokens:     128000,
		Headers:       nil,
	})
