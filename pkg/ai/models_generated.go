...
// Generated at: 2026-09-17T02:12:39Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 2, Output: 11.2, CacheRead: 0.232, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     943718,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.833, Output: 2.618, CacheRead: 0.13685, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     943718,
		Headers:       nil,
	})
