...
// Generated at: 2026-09-03T19:04:41Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 1.034256, Output: 2.068512, CacheRead: 0.086188, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 1.148, Output: 3.608, CacheRead: 0.1886, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     943718,
		Headers:       nil,
	})
