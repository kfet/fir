...
// Generated at: 2026-09-15T23:14:34Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.07476, Output: 0.14952, CacheRead: 0.014952, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.055, Output: 0.11, CacheRead: 0.011, CacheWrite: 0},
