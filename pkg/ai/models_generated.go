...
// Generated at: 2026-09-23T01:30:51Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.088606, Output: 0.177212, CacheRead: 0.0177212, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 1.45, Output: 11.7, CacheRead: 0.3, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     943718,
		Headers:       nil,
	})
