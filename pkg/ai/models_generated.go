...
// Generated at: 2026-09-07T17:36:14Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text", "image"},
		Cost:          ModelCost{Input: 0.07125, Output: 0.2375, CacheRead: 0.01425, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     131072,
		Headers:       nil,
	})
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 1.12, Output: 3.52, CacheRead: 0.208, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     943718,
		Headers:       nil,
	})
