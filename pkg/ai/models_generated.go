...
// Generated at: 2026-09-17T15:06:15Z
package ai
...
func init() {
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.07, Output: 0.14, CacheRead: 0.014, CacheWrite: 0},
		ContextWindow: 1048576,
		MaxTokens:     384000,
		Headers:       nil,
	})
	...
	RegisterModel(&Model{
		...
		Reasoning:     true,
		Input:         []string{"text"},
		Cost:          ModelCost{Input: 0.03, Output: 0.13, CacheRead: 0.01, CacheWrite: 0},
		ContextWindow: 1310720,
		MaxTokens:     393216,
		Headers:       nil,
	})
