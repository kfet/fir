...
- **Simplify** — use `/simplify [focus]` to review recent git changes (staged, unstaged, or last commit) and apply simplifications across code reuse, quality, and efficiency. Optional focus text narrows the review (e.g. `/simplify memory allocation`).
