...
When a generator's upstream TS file changes: (1) apply logic changes to the Go generator, (2) run it, (3) verify build+tests, (4) update the hash in the Go file and in `sync/.baseline-hashes`.
...
| `ai/src/models.ts` + `ai/src/models.generated.ts` | `pkg/ai/models.go` + `pkg/ai/models_generated.go` | ✅ (generated by `cmd/generate-models`) |
